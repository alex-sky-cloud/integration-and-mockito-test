package wiremock.demo.prorgammaticallymanage;
...
public class ProgrammaticallyManagedLiveTest {
    ...
    public void givenProgrammaticallyManagedServer_whenUsingSimpleStubbing_thenCorrect() throws IOException {
        ...
        UrlPattern urlPattern = urlEqualTo(BAELDUNG_PATH);
        ...
        /**метод из библиотеки WireMock, который выполняет сопоставление созданной загрузки**/
